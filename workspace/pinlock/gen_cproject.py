...
middlewares = {
    'mbedtls': {
        ...
        'includes': [
            '${ProjDirPath}/Middlewares/Third_Party/mbedTLS/include',
        ],
        'directories': {
            'Middlewares': 'Third_Party/mbedTLS/configs/|Third_Party/mbedTLS/doxygen/|Third_Party/mbedTLS/library/templates/|Third_Party/mbedTLS/programs/|Third_Party/mbedTLS/scripts/|Third_Party/mbedTLS/tests/|Third_Party/mbedTLS/visualc/|Third_Party/mbedTLS/yotta/',
        },
    },
}
