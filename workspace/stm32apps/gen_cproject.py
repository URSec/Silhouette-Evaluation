...
middlewares = {
    'fatfs': {
        ...
        'includes': [
            '${ProjDirPath}/Middlewares/Third_Party/FatFs/src/drivers',
            '${ProjDirPath}/Middlewares/Third_Party/FatFs/src',
        ],
        'directories': {
            'Middlewares': 'Third_Party/FatFs/src/drivers/|Third_Party/FatFs/src/option/ccsbcs.c|Third_Party/FatFs/src/option/cc950.c|Third_Party/FatFs/src/option/cc949.c|Third_Party/FatFs/src/option/cc936.c|Third_Party/FatFs/src/option/cc932.c|Third_Party/FatFs/doc/res/app4.c|Third_Party/FatFs/doc/res/app3.c|Third_Party/FatFs/doc/res/app2.c|Third_Party/FatFs/doc/res/app1.c',
        },
    },
}
...
programs = {
    'fatfs_ram': {
        ...
        'includes': [
            '${ProjDirPath}/inc/fatfs_ram',
            '${ProjDirPath}/inc',
        ],
        'cflags': [
            '-mllvm -arm-silhouette-shadowstack-offset=0x40000',
        ],
        'ldflags': [
            '-Wl,-mllvm,-arm-silhouette-shadowstack-offset=0x40000',
        ],
        'directories': {
            'src': 'fatfs_usd/|lcd_animation/|lcd_usd/',
        },
    },
    'fatfs_usd': {
        'includes': [
            '${ProjDirPath}/inc/fatfs_usd',
            '${ProjDirPath}/inc',
        ],
        'directories': {
            'src': 'fatfs_ram/|lcd_animation/|lcd_usd/',
        },
    },
    'lcd_animation': {
        'includes': [
            '${ProjDirPath}/inc/lcd_animation',
            '${ProjDirPath}/inc',
        ],
        'directories': {
            'src': 'fatfs_ram/|fatfs_usd/|lcd_usd/',
        },
    },
    'lcd_usd': {
        'includes': [
            '${ProjDirPath}/inc/lcd_usd',
            '${ProjDirPath}/inc',
        ],
        'directories': {
            'src': 'fatfs_ram/|fatfs_usd/|lcd_animation/',
        },
    },
}
...
def gen_core_settings_config(conf, program):
    ...
    xml += '                <option defaultValue="gnu.c.debugging.level.none" id="gnu.c.compiler.option.debugging.level.' + program_id + '" name="Debug Level" superClass="gnu.c.compiler.option.debugging.level" useByScannerDiscovery="false" value="gnu.c.debugging.level.none" valueType="enumerated"/>\n'
    ...
    # Add linker script
    xml += '                <option id="fr.ac6.managedbuild.tool.gnu.cross.c.linker.script.' + program_id + '" name="Linker Script (-T)" superClass="fr.ac6.managedbuild.tool.gnu.cross.c.linker.script" useByScannerDiscovery="false" value="${ProjDirPath}/LinkerScript' + ('-SRAM' if program == 'fatfs_ram' else '') + '.ld" valueType="string"/>\n'
